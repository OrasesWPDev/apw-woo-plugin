    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main apw-woo-single-product-main" role="main">
            ...
            <div class="apw-woo-section-wrapper apw-woo-header-block">
                <?php do_action('apw_woo_before_product_header', $product); ?>

                <h1 class="apw-woo-page-title"><?php echo esc_html($product->get_name()); ?></h1>

                <?php do_action('apw_woo_after_product_header', $product); ?>
            </div>
